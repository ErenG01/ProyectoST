...
<body>
	...
	<section id="container">
		...
		<form action="../reportespdf/reporte_clientes.php" method="post" class="formu_report" enctype="multipart/form-data">
		...
		<?php  
			...
			$query = mysqli_query($conection,"SELECT cliente.id_cliente, cedula.tipo_documento, cliente.numero_documento, cliente.nombre, cliente.correo, cliente.telefono, cliente.direccion FROM cliente cliente INNER JOIN cedula cedula ON cliente.cedula = cedula.Id_cedula where estatus = 1 ORDER BY cliente.id_cliente ASC limit $desde,$por_pagina");
